...
export const HeaderListaTickets = () => {
  return (
    <ul
      className={`flex uppercase justify-between flex-row shadow-3xl text-slate-500 px-12 w-full text-lg font-medium list-none bg-[#ffffff94] backdrop-blur-sm sticky top-0 z-10 py-3.5 border-b border-opacity-10 border-black items-center ${styles.headerListaTicket}`}
    >
